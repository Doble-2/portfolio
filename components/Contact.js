    ...
    <section id="contactArea" className="bg-white">
      ...
      >
        <div className="place-self-center  px-4 py-4  lg:col-span-7">
          <h3 className="max-w-2xl text-center mb-4 text-2xl font-extrabold tracking-tight leading-none md:text-3xl xl:text-3xl ">
            Contáctame
          </h3>
          ...
          <div className=" flex wrap">
            <Link
              className="mx-3"
              href="https://www.linkedin.com/in/angeld2/"
              target="blank"
            >
            ...
            <Link
              href="https://twitter.com/Doble2_?t=UQAHOXx_gSOoTZp9THuJ4g&s=09"
              className="mx-3"
              target="blank"
            >
              <div className="flex font-bold">
