  ...
  return (
    ...
    <div className=" lg:mt-0 lg:col-span-5 flex justify-center">
        ...
        <div className="lg:ml-20 place-self-center  px-6 py-4  lg:col-span-7">
            <h1 className="max-w-2xl text-center mb-4 text-2xl font-extrabold tracking-tight leading-none md:text-3xl xl:text-3xl ">Actualmente colaborando en Enviosfarma</h1>
            <p className="max-w-2xl mb-6 font-light lg:mb-8 text-lg  md:text-lg lg:text-xl ">Labore elit adipisicing mollit Lorem laborum culpa incididunt fugiat velit ut magna consectetur quis amet. Excepteur ad Lorem mollit sunt mollit cupidatat ea tempor Lorem est. Est ipsum pariatur nulla sit culpa est aliquip nulla esse ipsum. Proident nisi deserunt aliquip culpa culpa laboris reprehenderit ut adipisicing.</p>
            ...
            <a href="/angel4.png" download className="bg-black txt-center ring-white ring-1  inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white  rounded-lg hover:bg-gray-900 focus:ring-1 focus:ring-gray-100 ">
                Ver mas
            </a> 
            </div>
