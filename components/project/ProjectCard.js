    ...
    >
      ...
      <div className="p-5">
        ...
        <Link href={"project/[id]"} as={"project/" + data.id}>
          <p
            href="#"
            className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white ring-white ring-1 rounded-lg focus:ring-1 focus:ring-gray-100  hover:bg-black-900  bg-black "
          >
            Ver más
            <svg
              aria-hidden="true"
