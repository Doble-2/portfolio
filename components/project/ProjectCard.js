...
//image = '../public/projects/' + data.name +'/'+ data.images[0];
  return (
    <div class="card mx-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
    ...
    <div class="p-5">
        ...
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{data.id} {data.desc}</p>
