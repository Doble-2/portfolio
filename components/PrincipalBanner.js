        ...
        <div className="lg:mr-20 place-self-center lg:col-span-7">
          ...
          <div className="hidden sm:block">
            ...
            <a
              ...
              download
              className="bg-black ring-white ring-1  inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white  rounded-lg hover:bg-gray-900 focus:ring-1 focus:ring-gray-100 "
            >
              Descargar
            </a>
          </div>
