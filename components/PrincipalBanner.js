  ...
  return (
    ...
    <div className="grid  sm:flex max-w-screen-xl px-8 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16  lg:px-16 lg:grid-cols-12" >
        <div className="lg:mr-20 place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 tracking-tight leading-none text-2xl font-bold  md:text-1xl xl:text-2xl ">Hola soy<p className=' text-3xl font-extrabold  md:text-3xl xl:text-4xl '>Ángel Calderón</p> </h1>
            ...
            <a href="/AngelCalderonCV.pdf" download className="bg-black ring-white ring-1  inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white  rounded-lg hover:bg-gray-900 focus:ring-1 focus:ring-gray-100 ">
                Descargar
            </a> 
            </div>
