...
export default function PrincipalBanner() {
  return (
    <section class=" px-10">
    <div class="grid  sm:flex max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12" data-aos="fade-down">
        <div class="lg:mr-20 place-self-center lg:col-span-7">
            ...
            <a href="/angel4.png" download class="bg-black ring-white ring-1  inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white  rounded-lg hover:bg-gray-900 focus:ring-1 focus:ring-gray-100 ">
                Descargar
            </a> 
            </div>
